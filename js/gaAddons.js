...
// Set to true to use event tracking for outbound links
// Set to false to use trackPageview for outbound links
var bUseEventForDownload = false;
// Set to true to use event tracking for downloads
...
// Need to add the following after closing script tag at end of GATC (assuming this file is in /js folder):
// <script src="/js/gaAddons.js" type="text/javascript">< /script> (remove space after < which is just there to keep tag as comment 
