...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   <br />
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" ConflictDetection="CompareAllValues"
        ...
        SelectCommand="SELECT tblFeatureCom.Fcomnum, tblFeatureCom.Fnum, tblFeatureCom.Fcom, tblFeatureCom.DateIn, tblFeatureCom.Author, tblFeature.ftitle FROM (tblFeatureCom INNER JOIN tblFeature ON tblFeatureCom.Fnum = tblFeature.fnum) ORDER BY tblFeatureCom.DateIn DESC"
