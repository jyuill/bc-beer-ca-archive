...
Sub Page_Load()
         If Not IsPostback Then
                ...
                Dim strSqlC as string = "SELECT Category, CatNum, Bmark FROM tblLinkCategory WHERE Category ORDER BY CatNum"
                Dim objAdapterC as New OledbDataAdapter(strSQLC, objConnection)
                ...
                Dim objAdapterL as New OledbDataAdapter(strSQLL, objConnection)
